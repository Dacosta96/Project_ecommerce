  ...
  const renderLogin =()=>{
    return(
      <><div className="flex flex-col mx-4">
        ...
        <span className="bg-black/5 rounded-lg"> {parsedAccount?.email} </span>
      </div><div className="flex flex-col mx-4 pb-8">
          <label className="font-medium text-lg ">Password:</label>
          <span className="bg-black/5 rounded-lg">{parsedAccount?.password}</span>
        </div>
        <Link to="/"><button
        ...
        <button
          className=" py-3 w-11/12 text-black rounded-lg mb-4 mx-4 border border-black "
